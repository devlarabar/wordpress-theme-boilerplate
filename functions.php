...
if (!function_exists('practicetheme_setup')) {
    ...
    */
    function practicetheme_setup()
    {
        ...
        If you're building a theme based on Crafty Press, use a find and replace to change 'practicetheme' to the name of your theme in all the template files.
		*/
        ...
        */
        ...
        register_nav_menus(array(
            ...
            'footer' => esc_html__('Footer Menu', 'practicetheme'),
            'header_action' => esc_html__('Header Action', 'practicetheme'),
        ));
...
function practicetheme_content_width()
{
    ...
    $GLOBALS['content_width'] = apply_filters('practicetheme_content_width', 1170);
}
...
@since 1.0.0
*/
function practicetheme_sidebar_widgets_init()
{
    // Default Sidebar
...
add_action('widgets_init', 'practicetheme_sidebar_widgets_init');

/*
Enqueue public scripts and styles
*/
function practicetheme_public_scripts()
{
    // Styles
...
add_action('wp_enqueue_scripts', 'practicetheme_public_scripts');

/*
Enqueue admin scripts and styles
*/
function practicetheme_admin_scripts()
{
}
add_action('admin_enqueue_scripts', 'practicetheme_admin_scripts');
